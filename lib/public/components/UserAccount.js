    ...
    const ACCOUNT_SECTIONS = [
      {
        ...
        component: (
          <div>
            <Panel>
              <Panel.Heading><Panel.Title componentClass='h3'>Informacja profilowa</Panel.Title></Panel.Heading>
              <ListGroup>
                <ListGroupItem>
                ...
                <ListGroupItem>
                  ...
                  <a href='http://gravatar.com'>
                    <img
                      ...
                      src={profile.picture}
                      width={40} />
                    <span style={{marginLeft: '10px'}}>Zmień na gravatar.com</span>
                  </a>
                </ListGroupItem>
                <ListGroupItem>
          ...
          <Row style={{marginBottom: '20px'}}>
            <Col xs={12}>
              <h1>
                ...
                <Icon type='user' /> Moje ustawienia
              </h1>
            </Col>
          </Row>
          <Row>
      ...
      {projectSubscriptions && (
        <div>
          ...
          {projectSubscriptions.target.length
            ...
            : <span>Żadne projektu aktualnie nie są obserwowane</span>
          }
        </div>
      )}
      {feedSubscriptions && (
        <div style={{ marginTop: 30 }}>
          <h4><Icon type='eye' /> Obejrzane Źródła</h4>
          {feedSubscriptions.target.length
            ...
            : <span>Żadne źródłą obecnie nie są obserwowane</span>
          }
        </div>
      )}
      {deploymentSubscriptions && (
        <div style={{ marginTop: 30 }}>
          <h4><Icon type='eye' /> Obserwowane wdrożenia</h4>
          {deploymentSubscriptions.target.length
            ...
            : <span>Żadne wdrożenia teraz nie są obserwowane</span>
          }
        </div>
      )}
    </div>
  ...
  render () {
    ...
    return (
      <ListGroupItem>
        ...
        ><Icon type='eye-slash' /> Przestań obserwować</Button>
      </ListGroupItem>
    )
  }
}
