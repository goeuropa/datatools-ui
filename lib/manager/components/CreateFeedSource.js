...
export default class CreateFeedSource extends Component<Props, State> {
  ...
  render () {
    ...
    return (
      <Row>
        <Col xs={12}>
          <h3>Stwórz nowe źródło</h3>
        </Col>
        <Col sm={8} xs={12}>
          <Panel>
            <Panel.Heading><Panel.Title componentClass='h3'>Ustawienia</Panel.Title></Panel.Heading>
            <ListGroup>
              <ListGroupItem>
                <FormGroup
                ...
                >
                  <ControlLabel>Nazwa źródła</ControlLabel>
                  <FormControl
                    name={'name'}
                  ...
                  {!validation.name && <HelpBlock>Wymagane</HelpBlock>}
                </FormGroup>
              </ListGroupItem>
              <ListGroupItem>
                <FormGroup>
                  ...
                  >
                    <strong>Umożliwij wdrożenie źródła</strong>
                  </Checkbox>
                  <small>
                    Pozwól temu źródłu być wdrożonym na OTP.Enable this feed source to be deployed to an
          ...
          <Panel>
            <Panel.Heading><Panel.Title componentClass='h3'>Automatycznie pobierz</Panel.Title></Panel.Heading>
            <ListGroup>
              <ListGroupItem>
                <FormGroup validationState={validationState(validation.url)}>
                  <ControlLabel>URL do pobrania</ControlLabel>
                  <FormControl
                    name={'url'}
                  ...
                  />
                  <FormControl.Feedback />
                  {!validation.url && <HelpBlock>Proszę wpisać poprawny URL</HelpBlock>}
                </FormGroup>
              </ListGroupItem>
              <ListGroupItem>
                <FormGroup>
                  ...
                  >
                    <strong>Auto wgraj źródło</strong>
                  </Checkbox>
                  <small>
                    Wybierz wczytywanie automatyczne. Set this feed source to fetch automatically. (Feed
          ...
          {isExtensionEnabled('mtc') && (
            <Panel>
              <Panel.Heading><Panel.Title componentClass='h3'>Automatyczna publikacja</Panel.Title></Panel.Heading>
              <ListGroup>
                <ListGroupItem>
                  <FormGroup>
                    <Checkbox
                    ...
                    >
                      <strong>Auto publikuj to źródło</strong>
                    </Checkbox>
                    <small>
                      Automatycznie publikuj to źródło kiedy źródło zostanie pobrane. 
                    </small>
                  </FormGroup>
                </ListGroupItem>
              </ListGroup>
