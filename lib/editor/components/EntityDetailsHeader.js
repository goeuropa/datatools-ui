...
function EntityDetailsHeader(props: Props) {
  ...
  const _showFareAttributes = () => props.toggleEditFareRules(false);

  const _showFareRules = () => props.toggleEditFareRules(true);
