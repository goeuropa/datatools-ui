...
return (
  <Nav bsStyle="pills">
    <NavItem
      ...
      href={`#/feed/${feedSource.id.toString()}/route/${route}/trippatterns`}
    ...
    <NavItem
      ...
      href={`#/feed/${feedSource.id.toString()}/route/${route}/stops`}
      onClick={() => setActiveEntity({ entity: activeEntity, component: 'route' })}
    >
    ...
    <NavItem
      ...
      href={`#/feed/${feedSource.id.toString()}/route/${route}/fares`}
      onClick={() => setActiveEntity({ entity: activeEntity, component: 'route' })}
    >
