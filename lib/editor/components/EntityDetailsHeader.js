...
const EntityDetailsHeader = (props: Props) => {
  ...
  //TODO endpoint to number
    ...
    //old logic
      ...
      function _showFareAttributes() = this.props.toggleEditFareRules(false)

      function _showFareRules() = this.props.toggleEditFareRules(true)
