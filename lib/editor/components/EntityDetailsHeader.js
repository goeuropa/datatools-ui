...
/*  Object.keys(params).forEach((paramName) => {
  ...
  const onClickPdf = (r) => {
    ...
    //let {token} = // FIXME What if authentication is turned off.
    //if (!token) {
    //  console.warn('Cannot fetch without user token.')
  //    token = 'no_auth'
  //  }
    const headers: {[string]: string} = {
      'Authorization': `Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkREeDlIZlYxU3doU2ZBZHdrOXlpdCJ9..iLxv_sScDB6EyJ4BYdoxLLrvSWZ-OOeDCmWoW1vqpkg7XZeXQWxXkdpp1fhwzA_HrHyT-i6KI3WftPFCqqdHZENmqr917zqBgbU3ep8HkPnQRXKEDwAMKFilDUeQzHwjdWH5ZGcxtLJQqi0cMdXhvxP-O1EltSMiH2ZotajYXWBVvRfPvxn9sp91ysfdaWjDz6pYOg_jcrkVg5iGVYCJM9tR__6hmpvqHLzAfaxOnHvT_35rcEytDwLWwGd6JLThVPOmP7Z5aPc5qJwgfM7izdSnlpWMTq5P1DfmctsAHAr8x5gCCRo256dMOGb1B9P_aZM-MtGSncfX26GcQW6SyQ`,
...
//    }
    ...
    console.log(headers);
    fetch(url, { method: 'GET', // Specify the HTTP method (e.g., GET, POST, etc.)
