...
return (
  <Nav bsStyle="pills">
    <NavItem
      ...
      href={`#/feed/${feed.toString()}/route/${route.toString()}/trippatterns`}
    ...
    <NavItem
      ...
      href={`#/feed/${feed.toString()}/route/${route.toString()}/stops`}
      onClick={() => setActiveEntity({ entity: activeEntity, component: 'route' })}
    >
    ...
    <NavItem
      ...
      href={`#/feed/${feed.toString()}/route/${route.toString()}/fares`}
      onClick={() => setActiveEntity({ entity: activeEntity, component: 'route' })}
    >
